...
def predict_future_position_xgboost(model, data, future_steps=5, lag=1):
    predictions = []
...
if __name__ == "__main__":
    ...
    model, lag = train_xgboost(train_data)

    future_positions = predict_future_position_xgboost(model, train_data, future_steps=len(test_times), lag=lag)
